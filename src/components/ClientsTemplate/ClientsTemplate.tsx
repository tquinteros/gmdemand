...
const ClientsTemplate = () => {
    return (
        <div className='min-h-screen relative'>
            <div className=''>
                <h2 className='text-6xl font-bold mb-8 text-center uppercase'>Check our happy clients:</h2>
            </div>
            <div className='grid grid-cols-12 px-4 container mx-auto py-12 bg-[#F5F5F5] gap-8'>
                <div className='col-span-12 md:col-span-6 flex flex-col gap-8 pt-8  bg-white'>
